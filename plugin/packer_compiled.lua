...
_G.packer_plugins = {
  ...
  gruvbox = {
    ...
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["live-server.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/live-server.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["nvim-highlight-colors"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/nvim-highlight-colors",
  ...
  ["opener.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/opener.nvim",
  ...
  ["vim-move"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/vim-move",
